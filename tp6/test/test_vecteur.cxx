...
//  Tests : ces tests unitaires vérifient le comportement de la classe Vecteur 

// Test des différents constructeurs implémentés
...
// Test de la méthode  norme, qui renvoie la norme euclidienne 
...
// Vérification du cas de la division par 0
TEST(VecteurTest, DivisionByZero) {
    Vecteur v(1, 2, 3);
    EXPECT_ANY_THROW({Vecteur r = v / 0.0;});
}

// Test des opérations chainées 
...
// Test du constructeur par copie et de l'opérateur d'affectation
...
// Test avec de très grand nombres
